...
import pinch2zoom.GestureImageViewTouchListener;
...
public class PictureGalleryView extends FrameLayout {
    ...
    public void updateData(ArrayList<String> imageList, ArrayList<String> describeList, ArrayList<String> relatedGallerie) {
